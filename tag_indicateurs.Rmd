...
On ajoute des icones aux boutons en cherchant dans le catalogue [font-awesome](https://fontawesome.com/)
...
Maintenant on passe à la logique côté serveur, plus complexe à gérer. On va commencer par le plus simple, passer l'indicateur et afficher le suivant.
Pour cela on a besoin de gérer une liste d'indicateurs déjà traités (taggés ou passés). Pour cela on aura recours à des reactifs.
